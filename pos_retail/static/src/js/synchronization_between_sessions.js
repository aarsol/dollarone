odoo.define('pos_retail.synchronization', function (require) {
    ...
    models.PosModel = models.PosModel.extend({
        ...
        syncing_sessions: function (message) {
            ...
            if (action == 'set_variant_product') {
                this.sync_set_variant_product(message['data']);
            }
        ...
        sync_set_variant_product: function (vals) {
            var line = this.get_line_by_uid(vals['uid']);
            if (line) {
                line.syncing = true;
                line.set_variant_product(vals['variant_product']);
                line.syncing = false;
                return true
            }
        },
    ...
    models.Order = models.Order.extend({
        ...
        export_as_JSON: function () {
            ...
            json.time_elapsed = Math.floor(((new Date() - (new Date (new Date().toDateString() + ' ' + this.created_time)))/1000)/60);
