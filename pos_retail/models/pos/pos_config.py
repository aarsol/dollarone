...
class pos_config(models.Model):
    ...
    gst = fields.Boolean('GST',default=True)
    fixed_pos_discount = fields.Boolean('Allow Fixed Discount', default=1)
    ...
    discount_product_id = fields.Many2one('product.product', 'Fixed Discount Product', domain=[('sale_ok', '=', True), ('available_in_pos', '=', True)], required=1)
    
    keyboard_price = fields.Char('Shortcut Price', required=True, default='P')
    keyboard_quantity = fields.Char('Shortcut Quantity', required=True, default='Q')
    keyboard_discount = fields.Char('Shortcut Discount', required=True, default='D')
    keyboard_search = fields.Char('Shortcut Search box', required=True, default='ctrl+s')
    keyboard_payment = fields.Char('Shortcut Payment', required=True, default='right')
    keyboard_new_order = fields.Char('Shortcut new order', required=True, default='+')
    keyboard_remove_order = fields.Char('Shortcut remove order', required=True, default='-')
    keyboard_add_client = fields.Char('Shortcut add customer', required=True, default='C')
    ...
    keyboard_invoice = fields.Char('Shortcut Invoice', required=True, default='ctrl+I')	
    keyboard_lock_session = fields.Char('Shortcut Lock Session', required=True, default='L')
    keyboard_lock_screen = fields.Char('Shortcut Lock Screen', required=True, default='K')	
    keyboard_global_discount = fields.Char('Shortcut Global Discount', help='If global discount is enabled it will work', required=True, default='G')
    keyboard_direct_discount = fields.Char('Shortcut Direct Discount', help='If direct discount is enabled it will work', required=True, default='T')

    keyboard_order_note = fields.Char('Shortcut Order Note', required=True, default='N')
    keyboard_line_note = fields.Char('Shortcut Line Note', required=True, default='M')
	
    keyboard_products = fields.Char('Shortcut Products', required=True, default='ctrl+U')
    keyboard_pos_orders = fields.Char('Shortcut POS Orders', required=True, default='R')	
    keyboard_return_products = fields.Char('Shortcut Return Products', required=True, default='Z')
    keyboard_clean_order = fields.Char('Shortcut Clean Order', required=True, default='X')
	
    keyboard_order_signature = fields.Char('Shortcut Order Signature', required=True, default='S')
    keyboard_daily_report = fields.Char('Shortcut Daily Report', required=True, default='W')
    keyboard_promotions = fields.Char('Shortcut Promotions', required=True, default='A')
	
    keyboard_booking = fields.Char('Shortcut Booking', required=True, default='B')
    keyboard_booked = fields.Char('Shortcut Booked', required=True, default='O')
    keyboard_delivery = fields.Char('Shortcut Delivery', required=True, default='Y')
    keyboard_unlock = fields.Char('Shortcut Unlock', required=True, default='U')
    keyboard_internal_transfer = fields.Char('Shortcut Internal Transfer', required=True, default='I')
    keyboard_voucher = fields.Char('Shortcut Voucher', required=True, default='V')
    keyboard_invoices = fields.Char('Shortcut Invoices', required=True, default='E')
	
    keyboard_purchase_order = fields.Char('Shortcut Purchase Order', required=True, default='ctrl+P')
    keyboard_sale_order = fields.Char('Shortcut Sale Order', required=True, default='ctrl+o')

    keyboard_combo = fields.Char('Shortcut Combo Items', required=True, default='ctrl+C')
    keyboard_combo_lot = fields.Char('Shortcut Combo Lot', required=True, default='alt+C')
    
    keyboard_reward = fields.Char('Shortcut Rewards', required=True, default='ctrl+G')
    keyboard_kitchen = fields.Char('Shortcut Kitchen Receipt', required=True, default='ctrl+K')
    keyboard_variants = fields.Char('Shortcut Variants', required=True, default='ctrl+V')
    keyboard_print_user_card = fields.Char('Shortcut User Card', required=True, default='ctrl+V')
    keyboard_print_last_order = fields.Char('Shortcut Print Last Order', required=True, default='alt+L')
